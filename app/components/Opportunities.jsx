...
const FeatureCard = ({text, imgLink}) => (
    <div className="  rounded-xl sm:rounded-2xl md:rounded-3xl lg:rounded-[40px] bg-white flex flex-col justify-center md:justify-around items-center py-4 sm:py-9 md:py-10 px-2 sm:px-8 h-52 sm:h-64 md:h-72 lg:h-80 min-w-32 flex-1 sm:flex-none sm:w-64 md:w-1/3 lg:w-1/5 z-10 shadow-md sm:shadow-lg md:shadow-xl">
        <Image className=" w-14 sm:w-20 md:w-24 mb-5" src={imgLink} width={50} height={50}/>
        
        <div className="text-center font-semibold text-sm sm:text-lg md:text-lg leading-6 md:leading-9 tracking-normal">
...
export const Opportunities = () => (
    <section className="w-full py-14 sm:py-16 md:py-24 px-4 sm:px-8 flex flex-col justify-evenly items-center bg-[#F3F3F3] min-h-screen relative overflow-hidden">
        ...
        <div className="w-full max-w-7xl flex flex-row items-center justify-center flex-wrap gap-3 sm:gap-12 md:gap-14 lg:gap-16">
