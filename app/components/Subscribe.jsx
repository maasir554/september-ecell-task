export const Subscribe = ({className=""}) => (
    <div className={"flex w-full rounded-3xl bg-white py-14 sm:py-16 md:py-20 px-10 sm:px-12 md:px-16 shadow-xl mt-20 items-end justify-center gap-10 flex-wrap " + className}>
        <span className="flex flex-col gap-4 ">
            <h3 className=" text-2xl lg:text-3xl text-secondary font-caveat">
        ...
        <span className="lg:flex-1 rounded-none p-5 sm:p-0 sm:rounded-full shadow-lg flex bg-neutral-100 overflow-hidden h-auto sm:h-14 md:h-16 md:min-w-[400px] w-full flex-wrap sm:flex-nowrap justify-center sm:justify-start gap-4 sm:gap-0 max-w-7xl" >  
