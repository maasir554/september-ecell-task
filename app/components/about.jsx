export const About = () => {
    return(
        <section className="w-full min-h-96 px-8 py-10 flex flex-col justify-start items-center">
            ...
            <p className="text-lg text-neutral-500 text-center w-full max-w-8xl leading-9 tracking-normal">
